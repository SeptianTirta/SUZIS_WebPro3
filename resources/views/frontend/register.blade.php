                ...
                <div class="card auth-card">
                    <div class="row g-0">
                        ...
                        <div class="col-md-5 auth-cover d-none d-md-flex">
                            <h2 class="fw-bold mb-3">Bergabung Bersama Suzis</h2>
                            <p class="opacity-75">Buat akun sekarang untuk mendapatkan akses penuh ke katalog eksklusif,
                                simulasi kredit, dan kemudahan booking armada secara online.</p>
                            <ul class="list-unstyled mt-4 opacity-75">
                                <li class="mb-2"><i class="bi bi-check-circle-fill text-danger me-2"></i> Transaksi Aman
                                </li>
                                <li class="mb-2"><i class="bi bi-check-circle-fill text-danger me-2"></i> Update Harga OTR
                                </li>
                        ...
                        <div class="col-md-7 p-4 p-md-5">
                            ...
                            <form action="{{ route('register.store') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="no_hp"
                                            ...
                                            value="{{ old('no_hp') }}" placeholder="0812xxxx" required>
                                        @error('no_hp')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6">
                                        <label class="fw-bold small text-muted text-uppercase mb-2">Konfirmasi
                                            Password</label>
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="{{ route('login') }}" class="text-decoration-none fw-bold"
                                        style="color: #EA5555;">Masuk di sini</a>
                                </div>
                            </form>
                        </div>
                    </div>
